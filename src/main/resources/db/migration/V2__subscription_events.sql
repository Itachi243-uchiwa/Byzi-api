-- EPIC-07.5 - Historique d'abonnement.
--
-- NOTE 2026-09-09 : ecrite a l'origine pour les webhooks RevenueCat, retires depuis. La
-- table n'a pas bouge - elle est agnostique de la source, et c'est ce qui permettra de
-- brancher App Store Server Notifications V2 sans migration.
--
-- Pourquoi une table d'evenements et pas seulement la colonne users.subscription_status :
--   1. Idempotence. Une source d'evenements rejoue tant qu'elle n'a pas recu de 2xx ; sans trace
...
--      expire ?" autrement qu'en fouillant App Store Connect.
...
create table subscription_events (
                                     ...
                                     -- id de l'evenement chez la source : la contrainte d'unicite EST le
                                     ...
                                     -- Date de l'evenement chez la source, distincte de la date de reception :
